// 2-5 Q1. 1. Write a program to show the number of lectures 
// of each module. The output should include module code, 
// title, and number of lectures per week.
const timetab = {
  acadYear: "2021/22",
  semester: 1,
  modules: [
...
for (let m of timetab.modules) {
  console.log(`${m.code} ${m.title} has ${m.lectures.length} lectures.`);
}
